# here we will create two dictionary for delta=4 based on tau_0=0.25
...
save(TheorySolution,file=paste0("TheorySolution_non_infor_syn_data_tau_0_0.12_delta_",delta,".RData"))
...
save(correspondence_eta_kappa1,file=
       paste0("correspondence_eta_kappa1_non_infor_syn_data_tau_0_0.12_delta_",delta,".RData"))
